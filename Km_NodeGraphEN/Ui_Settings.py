...
"}")
    ...
    def retranslateUi(self, SettingsWindowUI):
        ...
        self.label_14.setText(QCoreApplication.translate("SettingsWindowUI", u"<strong>Middle Button :</strong>   Edit", None))
        self.label_9.setText(QCoreApplication.translate("SettingsWindowUI", u"<strong>Left Button    :  </strong>Jump to Bookmark", None))
        self.label_4.setText(QCoreApplication.translate("SettingsWindowUI", u"Assign New Bookmark", None))
        self.label_3.setText(QCoreApplication.translate("SettingsWindowUI", u"<strong>Right Button  : </strong>   Remove", None))
